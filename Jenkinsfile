    ...
    stages {
       ...
       stage('Email Notification') {
            steps{
                ...
                Stage: Build Docker Image to DockerHub
                ...
                Final Report: The pipeline has completed successfully. No action required''', cc: '', from: '', replyTo: '', subject: 'Succès de la pipeline DevOps Project', to: 'aymennefzi67@gmail.com'
            }
        }
